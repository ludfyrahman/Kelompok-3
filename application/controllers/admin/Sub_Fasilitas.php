...
class Sub_fasilitas extends CI_Controller {
	function __construct()
  	{
		parent::__construct();
		$this->low = "sub_fasilitas";
		$this->cap = "Sub Fasilitas";
    ...
    public function index(){
        ...
        $data['list'] = $this->db->query("SELECT sb.*, f.nama as fasilitas from sub_fasilitas sb JOIN fasilitas f ON f.id=sb.id_fasilitas ORDER By id desc")->result_array();
