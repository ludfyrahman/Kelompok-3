...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #346FCD; height: 100%; margin: 0; padding: 0; width: 100%">
  <center>
 ...
 100%; background-color: #346FCD; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #346FCD;
 ...
 organize, share and use all your visual assets in one place - all on your desktop." height="32" src="<?= base_url('assets/images/logo/white.png') ?>" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                    <img align="center" alt="Forgot your password?" style="width:200px" class="mcnImage" src="https://img.icons8.com/clouds/100/000000/handshake.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 ...
 padding: 0'><span style="text-transform:uppercase">Verifikasi Email</span></h1>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Silahkan Konfirmasi Email anda
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href="<?= base_url('verifikasi/'.$kode) ?>" style="mso-line-height-rule: exactly;
