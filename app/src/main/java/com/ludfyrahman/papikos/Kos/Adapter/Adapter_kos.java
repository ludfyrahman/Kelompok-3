...
public class Adapter_kos extends RecyclerView.Adapter<Adapter_kos.ViewHolder> {
    private ArrayList<Kos_Model> listdata;
    private Activity activity;
    private Context context;

    public Adapter_kos(Activity activity, ArrayList<Kos_Model> listdata, Context context) {
    ...
    @Override
    public Adapter_kos.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.template_kos, parent, false);
        Adapter_kos.ViewHolder vh = new Adapter_kos.ViewHolder(v);
        return vh;
    }
    @Override
    public void onBindViewHolder(Adapter_kos.ViewHolder holder, int position) {
        final Adapter_kos.ViewHolder x = holder;
